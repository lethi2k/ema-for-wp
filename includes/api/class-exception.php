...
/**
 * Class EMA4WP_API_Exception
 *
 * @property string $title
 * @property string $detail
 * @property array $errors
 */
class EMA4WP_API_Exception extends Exception {
	...
	*/
	...
	/**
	 * EMA4WP_API_Exception constructor.
	 *
	...
	*/
	...
	public function __toString() {
		...
		// add errors from response data returned by ZozoEMA
