...
/**
 * Gets the ZozoEMA for WP options from the database
...
/**
 * Gets the ZozoEMA for WP API class (v3) and injects it with the API key
 *
 * @since 4.0
 * @access public
 *
...
/**
 * Gets the ZozoEMA for WP API class and injects it with the API key
 *
 * @deprecated 4.0
 * @use ema4wp_get_api_v3
 *
 * @since 1.0
 * @access public
 *
...
/**
 * Refreshes ZozoEMA lists. This can take a while if the connected ZozoEMA account has many lists.
 *
 * @return void
 */
