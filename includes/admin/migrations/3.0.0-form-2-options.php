...
$global_options = (array) get_option( 'ema4wp_form', array() );
...
foreach ( $posts as $post ) {
	...
	$options = (array) get_post_meta( $post->ID, '_ema4wp_settings', true );
	...
	update_post_meta( $post->ID, '_ema4wp_settings', $options );
}
