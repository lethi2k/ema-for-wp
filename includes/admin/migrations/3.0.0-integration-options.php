...
$old_options = get_option( 'ema4wp_lite_checkbox', array() );
$pro_options = get_option( 'ema4wp_checkbox', array() );
...
// save new settings
update_option( 'ema4wp_integrations', $new_options );

// delete old options
delete_option( 'ema4wp_lite_checkbox' );
delete_option( 'ema4wp_checkbox' );
