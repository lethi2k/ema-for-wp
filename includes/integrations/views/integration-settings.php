						...
						<tr valign="top">
							...
							if ( ! empty( $lists ) ) {
								...
								foreach ( $lists as $list ) {
									echo '<li><label>';
									echo sprintf( '<input type="checkbox" name="ema4wp_integrations[%s][lists][]" value="%s" class="ema4wp-list-input" %s> ', $integration->slug, $list->id, checked( in_array( $list->id, $opts['lists'], true ), true, false ) );
