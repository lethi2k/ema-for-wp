...
/**
 * Class EMA4WP_Integration_Manager
 *
 * @ignore
 * @access private
 */
class EMA4WP_Integration_Manager {
	...
	/**
	 * @var EMA4WP_Integration_Fixture[]
	 */
	protected $integrations = array();

	/**
	 * @var EMA4WP_Integration_Tags
	 */
	protected $tags;
	...
	*/
	public function __construct() {
		$this->tags = new EMA4WP_Integration_Tags();
	}
	 ...
	 *
	 * @return EMA4WP_Integration_Fixture[]
	 * @throws Exception
	 */
	...
	public function register_integration( $slug, $class, $enabled = false ) {
		...
		$this->integrations[ $slug ] = new EMA4WP_Integration_Fixture( $slug, $class, $enabled, $raw_options );
	}
	 ...
	 *
	 * @param EMA4WP_Integration_Fixture $integration
	 *
	 * @return bool
	 */
	public function is_enabled( EMA4WP_Integration_Fixture $integration ) {
	...
	private function load_options() {
		$options = (array) get_option( 'ema4wp_integrations', array() );
		 ...
		 * @ignore
		 */
		return (array) apply_filters( 'ema4wp_integration_options', $options );
	}
