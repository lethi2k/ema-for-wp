...
abstract class EMA4WP_Integration {
	...
	/**
	 * Get the selected ZozoEMA lists
	 *
	 ...
	 *
	 * @see EMA4WP_Integration::$checkbox_name
	 * @see EMA4WP_Integration::get_lists
	 * @see EMA4WP_Integration::checkbox_was_checked
	 *
	 * @return array
	 */
