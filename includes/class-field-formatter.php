...
/**
 * Class EMA4WP_Field_Formatter
 *
 * Formats values based on what the ZozoEMA API expects or accepts for the given field types.
 */
class EMA4WP_Field_Formatter {
	...
	public function birthday( $value, $options = null ) {
		...
		// ZozoEMA expects a MM/DD format, regardless of their display preference
	...
	public function date( $value, $options = null ) {
		...
		// ZozoEMA expects a Y-m-d format no matter the display preference
