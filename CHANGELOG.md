...
Please note that installing this update requires you to also update any add-ons like [ZozoEMA Top Bar](https://wordpress.org/plugins/zozoema-top-bar/) and [ZozoEMA for WordPress Premium](https://www.ema4wp.com/premium-features/) (if installed).
...
- Now logging all sign-ups from Ninja Forms integrations when using [ZozoEMA for WordPress Premium](https://www.ema4wp.com/premium-features/).
