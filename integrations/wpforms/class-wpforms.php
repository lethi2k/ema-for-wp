...
/**
 * Class EMA4WP_WPForms_Integration
 *
 * @ignore
 */
class EMA4WP_WPForms_Integration extends EMA4WP_Integration {
	...
	public function listen_to_wpforms( $fields, $entry, $form_data ) {
		foreach ( $fields as $field_id => $field ) {
			if ( $field['type'] === 'zozoema' && (int) $field['value_raw'] === 1 ) {
	...
	public function subscribe_from_wpforms( $checkbox_field_id, $fields, $form_data ) {
		...
		$zozoema_list_id      = $form_data['fields'][ $checkbox_field_id ]['zozoema_list'];
