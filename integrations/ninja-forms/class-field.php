...
/**
 * Class EMA4WP_Ninja_Forms_Field
 */
class EMA4WP_Ninja_Forms_Field extends NF_Abstracts_Input {

	protected $_name = 'ema4wp_optin';

	protected $_nicename = 'ZozoEMA';
	...
	public function __construct() {
		...
		$this->_nicename = __( 'ZozoEMA opt-in', 'zozoema-for-wp' );
	...
	* @param EMA4WP_Ninja_Forms_Field $field field model.
	* @return $value string|void
	*/
	public function custom_columns( $value, $field ) {
		// If the field type is equal to checkbox...
		if ( 'ema4wp_optin' === $field->get_setting( 'type' ) ) {
