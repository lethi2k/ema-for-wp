 ...
 * @ignore
 */
class EMA4WP_Ninja_Forms_Integration extends EMA4WP_Integration {
	...
	public function add_hooks() {
		add_action( 'ema4wp_integration_ninja_forms_subscribe', array( $this, 'subscribe_from_ninja_forms' ), 10, 7 );
	}
