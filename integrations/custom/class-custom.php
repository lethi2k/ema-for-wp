...
/**
 * Class EMA4WP_Custom_Integration
 * @ignore
 */
class EMA4WP_Custom_Integration extends EMA4WP_Integration {


	/**
	 * @var string
	 */
	protected $checkbox_name = 'ema4wp-subscribe';
	...
	*/
	...
	public function listen() {
		...
		// (since they use the same "ema4wp-subscribe" trigger)
