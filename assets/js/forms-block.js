...
var forms = window.ema4wp_forms;
registerBlockType('zozoema-for-wp/form', {
  title: __('ZozoEMA for WordPress Form'),
  description: __('Block showing a ZozoEMA for WordPress sign-up form'),
  category: 'widgets',
  attributes: {
    id: {
      type: 'int'
  ...
  edit: function edit(props) {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      label: __('ZozoEMA for WordPress Sign-up Form'),
  ...
  save: function save(props) {
    return null; // return `[ema4wp_form id="${props.attributes.id}"]`;
  }
});
